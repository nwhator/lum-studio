                  ...
                  <div className="col-xl-10">
                    <div className="text-center mb-60">
                      ...
                      <p className="service-detail-desc" style={{fontSize: '18px', color: '#333', lineHeight: 1.8, maxWidth: '800px', margin: '0 auto'}}>
                        Professional event coverage that captures the energy, emotion, and important moments of your special occasions with creative excellence.
                      </p>
                    </div>
                  </div>
                </div>
